...
stage ('openstack_install') {
	if (install_openstack) {
		...
		node('CCI && US') {
			...
			try {
			    openstack_build = build job: 'scale-ci-ScaleUp_Openshift',
				parameters: [   [$class: 'LabelParameterValue', name: 'node', label: node_label ],
						...
						[$class: 'StringParameterValue', name: 'INSTACKENV_JSON', value: instack_json ],
                                                [$class: 'StringParameterValue', name: 'TICKER_NUMBER', value: ticket ],
